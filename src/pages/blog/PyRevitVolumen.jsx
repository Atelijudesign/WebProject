    ...
    const chart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [
          ...
          {
            label: "Plugin pyRevit (~0 min)",
            data: [0, 0, 0, 0.17, 0.17],
      ...
      options: {
        ...
        plugins: {
          ...
          tooltip: {
            callbacks: {
              label: (context) =>
                context.datasetIndex === 1 ? " ~10 segundos" : " " + context.parsed.y + " minutos",
            },
          },
        },
      },
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex items-center justify-center gap-3 mb-4 flex-wrap">
            <span className="bg-orange-600/90 text-white text-xs font-bold px-3 py-1 rounded-full">
              <i className="fa-solid fa-weight-hanging mr-1" /> Plugin BIM
            </span>
      ...
      <section className="py-12 bg-[#0b1220]/60 transition-colors duration-300">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose-article">
          ...
          <div className="grid grid-cols-3 gap-4 mb-10">
            ...
            <div className="stat-card glass-card rounded-2xl p-6 border border-slate-800/60 text-center">
              <p className="text-4xl font-extrabold text-bim-blue mb-1">720×</p>
          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 border border-slate-800/60 mb-10">
            <h3 className="text-2xl font-extrabold text-white mb-4">
              <i className="fa-solid fa-triangle-exclamation text-red-400 mr-2" />
              El Problema Real
            </h3>
            <p className="text-slate-400">
              El flujo clásico de cubicación en cualquier oficina de proyectos se ve más o menos así: abres
              una vista en Revit, exportas una planilla de cantidades, la abres en Excel, filtras por tipo de
              material, calculas los pesos con fórmulas que alguien hizo hace tres años y nadie sabe si son
              correctas, y al final generas un reporte.
            </p>
            <p className="text-slate-400">
              El problema no es que sea lento — aunque lo es. El problema es que{" "}
              <strong className="text-white">
                el modelo y la planilla se desconectan desde el momento en que exportas
              </strong>
              . Cualquier cambio en el modelo requiere repetir todo el proceso desde cero.
            </p>
            <div className="callout callout-orange">
              <div className="callout-label">⚠️ El costo real</div>
              <p className="text-slate-400 text-sm">
                En un proyecto de mediana envergadura, un ciclo completo de cubicación manual puede tomar
                entre 2 y 4 horas. Si el modelo cambia dos veces a la semana — lo cual es normal — estás
                gastando casi un día completo en extraer datos que ya existen en el modelo.{" "}
                <strong className="text-gray-200">
                  La solución no es trabajar más rápido. Es no hacer ese trabajo en absoluto.
                </strong>
              </p>
            </div>
          </div>
          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 border border-slate-800/60 mb-10">
            <h3 className="text-2xl font-extrabold text-white mb-4">
              <i className="fa-solid fa-wand-magic-sparkles text-green-400 mr-2" />
              Qué Hace el Script
            </h3>
            <p className="text-slate-400">
              El script extrae directamente desde el modelo Revit, a través de su API, toda la información
              necesaria para generar una cubicación completa de acero y hormigón. Sin exportar nada, sin abrir
              Excel, sin fórmulas manuales.
            </p>
            <ul className="space-y-2 text-slate-400 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-gray-200">Detecta el material automáticamente</strong> — lee la
                  propiedad de material de cada elemento estructural y determina si es acero u hormigón.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-bim-blue mt-1">
                ...
                <span>
                  <strong className="text-gray-200">Extrae el volumen real</strong> — usa el parámetro de
                  volumen calculado por Revit, no una estimación.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-bim-blue mt-1">
                ...
                <span>
                  <strong className="text-gray-200">Calcula el peso con densidad real</strong> — aplica
                  7.850 kg/m³ para acero y 2.400 kg/m³ para hormigón por defecto, con valores configurables.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-bim-blue mt-1">
                ...
                <span>
                  <strong className="text-gray-200">Clasifica el acero por Nominal Weight</strong> — Liviana,
                  Media, Pesada y Extrapesada según el peso lineal del perfil.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-bim-blue mt-1">
                ...
                <span>
                  <strong className="text-gray-200">Agrega factor de conexiones</strong> — un porcentaje
                  configurable que se suma al peso total de acero.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-bim-blue mt-1">
                ...
                <span>
                  <strong className="text-gray-200">Muestra el reporte en consola</strong> — tablas
                  interactivas en pyRevit, sin abrir ningún archivo externo.
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 border border-slate-800/60 mb-10">
            ...
            <ul className="space-y-2 text-slate-400 text-sm mb-4">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-gray-200">Revit 2022 o superior</strong> — el script fue probado
                  en 2024 y 2025.
                </span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-gray-200">pyRevit 4.8+</strong> — descárgalo desde{" "}
                  <span className="ic">github.com/eirannejad/pyRevit</span>.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-orange-400 mt-1">
                ...
                <span>
                  <strong className="text-gray-200">Un modelo estructural activo</strong> — con elementos de
                  categoría Framing o Columns con materiales asignados.
                </span>
              </li>
            </ul>
            <div className="callout">
              ...
              <p className="text-slate-400 text-sm">
                No necesitas saber Python para usar este script. El tutorial te explica dónde poner cada
                archivo. Si quieres entender cómo funciona el código, las secciones de explicación son para ti.
              </p>
            </div>
          </div>
          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 border border-slate-800/60 mb-10">
            <h3 className="text-2xl font-extrabold text-white mb-6">
              <i className="fa-solid fa-list-ol text-bim-blue mr-2" />
              Paso a Paso
            </h3>
              ...
              <div className="step-item">
                ...
                <div className="step-body">
                  ...
                  <div className="step-desc">
                    pyRevit convierte carpetas en botones automáticamente. La estructura de nombres es el único
                    "framework" que necesitas entender.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="folder-tree mb-6">
              <span className="ft-folder">AG_Tools.extension/</span>{" "}
              <span className="ft-comment">← tu extensión principal</span>
              <br />
              &nbsp;&nbsp;<span class="ft-folder">Cubicación.tab/</span>{" "}
              <span className="ft-comment">← pestaña en el ribbon de Revit</span>
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;<span class="ft-folder">Reportes.panel/</span>{" "}
              <span className="ft-comment">← panel de botones</span>
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <span className="ft-folder">Cubicacion.pushbutton/</span>{" "}
              <span className="ft-comment">← el botón</span>
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <span className="ft-file">script.py</span>{" "}
              <span className="ft-comment">← tu código va aquí</span>
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <span class="ft-file">icon.png</span>{" "}
              <span className="ft-comment">← ícono 32×32 px (opcional)</span>
            </div>
              ...
              <div className="step-item">
                ...
                <div className="step-body">
                  <div className="step-title">
                    Crea el archivo <span className="ic">script.py</span>
                  </div>
                  <div className="step-desc">
                    Dentro de la carpeta <span className="ic">Cubicacion.pushbutton/</span>, crea un archivo
                    llamado exactamente <span className="ic">script.py</span> y pega el código completo de la
                    siguiente sección.
                  </div>
                </div>
              </div>
          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 border border-slate-800/60 mb-10 relative overflow-hidden">
            ...
            <h3 className="text-2xl font-extrabold text-white mb-2 relative z-10">
              <i className="fa-brands fa-python text-green-400 mr-2" />
              Código Completo
            </h3>
            <p className="text-slate-400 mb-5 relative z-10 text-sm">
              Script listo para producción. Cópialo directamente en tu <span className="ic">script.py</span>:
            </p>
            <CodeBlock code={pythonScriptCode} language="pyRevit" filename="script.py" />
          </div>
            ...
            <div className="steps-list">
              <div className="step-item">
                ...
                <div className="step-body">
                  ...
                  <div className="step-desc mb-4">
                    Al inicio del script hay una sección de configuración. Ajusta el porcentaje de
                    conexiones según las especificaciones de tu proyecto. El 5% es un valor estándar
                    conservador.
                  </div>
                </div>
              </div>
...
FACTOR_CONEXIONES = 0.05   # 5% estándar
            ...
            <div className="steps-list mt-6">
              <div className="step-item">
                ...
                <div className="step-body">
                  ...
                  <div className="step-desc">
                    Abre Revit → pestaña pyRevit → Settings → Custom Extensions. Agrega la ruta a tu carpeta{" "}
                    <span className="ic">AG_Tools.extension</span>. Luego haz clic en Reload.
                  </div>
                </div>
              </div>
              <div className="step-item">
                ...
                <div className="step-body">
                  ...
                  <div className="step-desc">
                    Con un modelo estructural abierto, busca la pestaña "Cubicación" en el ribbon. Haz clic
                    en el botón "Cubicacion". El reporte aparece en la consola de pyRevit en segundos.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 border border-slate-800/60 mb-10">
            <h3 className="text-2xl font-extrabold text-white mb-4">
              <i className="fa-solid fa-terminal text-green-400 mr-2" />
              Resultado Esperado
            </h3>
            <p className="text-slate-400 mb-5">
              Si el modelo tiene materiales correctamente asignados, el reporte se ve así en la consola de
              pyRevit:
            </p>
            <div className="result-box">
              <h4>// Output consola pyRevit</h4>
              <pre>{`📊 Reporte de Cubicación Estructural
...
Peso total:     2.977.200 kg  (2.977,20 ton)`}</pre>
            </div>
          </div>
          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 border border-slate-800/60 mb-10">
            <h3 className="text-2xl font-extrabold text-white mb-6">
              <i className="fa-solid fa-gears text-bim-blue mr-2" />
              Cómo Funciona el Código
            </h3>

            <h4 className="font-bold text-gray-200 mb-2">Detección de material</h4>
            <p className="text-slate-400 text-sm">
              La función <span className="ic">obtener_nombre_material()</span> lee el parámetro{" "}
              <span className="ic">STRUCTURAL_MATERIAL_PARAM</span> de cada elemento, obtiene el ID del
              material asignado y consulta su nombre en el documento. Las funciones{" "}
              <span className="ic">es_acero()</span> y <span className="ic">es_hormigon()</span> buscan
              palabras clave en ese nombre — por eso es importante que tus materiales en Revit tengan nombres
              descriptivos.
            </p>

            <h4 className="font-bold text-gray-200 mb-2 mt-6">Extracción del volumen</h4>
            <p className="text-slate-400 text-sm">
              Revit calcula el volumen real de cada elemento estructural y lo almacena en el parámetro{" "}
              <span className="ic">HOST_VOLUME_COMPUTED</span>. La API lo entrega en pies cúbicos — la
              conversión a m³ la hace <span className="ic">UnitUtils.ConvertFromInternalUnits()</span>. Este
              valor ya considera la geometría exacta del perfil, no una aproximación.
            </p>

            <div className="callout callout-green mt-4">
              <div className="callout-label">✅ Por qué esto es más preciso que Excel</div>
              <p className="text-slate-400 text-sm">
                El volumen calculado por Revit considera los cortes, uniones y modificaciones de geometría
                que aplicaste al modelo. Una tabla de Excel con fórmulas de largo × área de sección no hace eso.{" "}
                <strong className="text-gray-200">
                  La diferencia puede ser de hasta 3–5% en estructuras con muchas uniones
                </strong>
                .
              </p>
            </div>
            ...
            <p className="text-slate-400 text-sm">
              El script calcula el peso lineal de cada elemento dividiendo el peso total por el largo de corte
              estructural. Con ese valor clasifica el perfil en una de las cuatro categorías estándar. Esto es
              útil para separar las cotizaciones por tipo de perfil, que en Chile generalmente tienen precios
              distintos por categoría NW.
            </p>
          </div>
          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 border border-slate-800/60 mb-10">
            <h3 className="text-2xl font-extrabold text-white mb-4">
              <i className="fa-solid fa-chart-bar text-cyan-400 mr-2" />
            ...
            <div className="chart-container">
              <canvas ref={chartRef} id="timeComparisonChart" />
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
              <div className="p-4 bg-red-900/20 rounded-xl border border-red-800/30">
                <h4 className="font-bold text-red-400 text-sm mb-2">
                  <i className="fa-solid fa-xmark mr-1" /> Flujo Manual (~2 horas)
                </h4>
                <ul className="text-slate-400 text-xs space-y-1 mb-0">
              ...
              <div className="p-4 bg-green-900/20 rounded-xl border border-green-800/30">
                <h4 className="font-bold text-green-400 text-sm mb-2">
                  <i className="fa-solid fa-check mr-1" /> Con el Plugin (~10 segundos)
                </h4>
                <ul className="text-slate-400 text-xs space-y-1 mb-0">
          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 border border-slate-800/60 mb-10">
            <h3 className="text-2xl font-extrabold text-white mb-6">
              <i className="fa-solid fa-bug text-orange-400 mr-2" />
              Troubleshooting
            </h3>
            ...
            <div className="space-y-5">
              <div>
                ...
                <p className="text-slate-400 text-sm mb-0">
                  Verifica que el nombre de tu carpeta termine exactamente en <span className="ic">.extension</span>,{" "}
                  <span className="ic">.tab</span>, <span className="ic">.panel</span> y{" "}
                  <span className="ic">.pushbutton</span>. Un espacio de más o una mayúscula incorrecta hace
                  que pyRevit no lo reconozca. Luego haz Reload.
                </p>
              </div>
              <div className="border-t border-slate-800 pt-5">
                <h4 className="font-bold text-gray-200 mb-1 text-sm">Elementos sin material asignado</h4>
                <p className="text-slate-400 text-sm mb-0">
                  Si el reporte muestra elementos sin material, abre el modelo, selecciona esos elementos y
                  asigna el material estructural correcto en las propiedades. El script avisa cuántos tienen
                  ese problema.
                </p>
              </div>
              <div className="border-t border-slate-800 pt-5">
                <h4 className="font-bold text-gray-200 mb-1 text-sm">
                  Error de conversión de unidades (Revit &lt; 2022)
                </h4>
                <p className="text-slate-400 text-sm mb-0">
                  En versiones anteriores a 2022, <span className="ic">UnitTypeId</span> no existe. Reemplaza
                  la conversión por <span className="ic">DisplayUnitType.DUT_CUBIC_METERS</span>, que es el
                  equivalente en versiones más antiguas.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card rounded-2xl p-8 md:p-10 border border-slate-800/60 border-l-4 border-l-bim-blue">
            ...
            <ul className="space-y-3 mb-0">
              <li className="flex items-start text-slate-400">
                ...
                <span>
                  <strong className="text-white">El modelo es la fuente de verdad.</strong> Si el modelo
                  cambia, el reporte también. Sin exportar nada, sin versiones desactualizadas.
                </span>
              </li>
              <li className="flex items-start text-slate-400">
                <span className="text-bim-blue mr-2 mt-1">
                ...
                <span>
                  <strong className="text-white">
                    La detección por palabras clave es frágil si los materiales no tienen nombres
                    descriptivos.
                  </strong>{" "}
                  Estandariza los nombres de materiales en tu plantilla de proyecto.
                </span>
              </li>
              <li className="flex items-start text-slate-400">
                <span className="text-bim-blue mr-2 mt-1">
                ...
                <span>
                  <strong className="text-white">pyRevit hace que la automatización sea accesible.</strong>{" "}
                  Sin compilar DLLs ni configurar Visual Studio. Solo Python y la estructura de carpetas
                  correcta.
                </span>
              </li>
              <li className="flex items-start text-slate-400">
                ...
                <span>
                  <strong className="text-white">
                    Cuando el proceso tarda 10 segundos, puedes iterar. Cuando tarda 2 horas, evitas hacerlo.
                  </strong>{" "}
                  Esa diferencia cambia cómo diseñas.
                </span>
              </li>
            </ul>
          </div>
