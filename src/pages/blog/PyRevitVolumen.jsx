...
{/*  Stats Banner  */}
        <div className="grid grid-cols-3 gap-4 mb-10">
          <div className="stat-card glass-card rounded-2xl p-6 border border-gray-200 dark:border-gray-700 text-center">
...
{/*  El Problema  */}
        <div className="glass-card rounded-2xl p-8 md:p-10 border border-gray-200 dark:border-gray-700 mb-10">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            El problema no es que sea lento �?�?� aunque lo es. El problema es que <strong className="text-gray-900 dark:text-white">el modelo y la planilla se desconectan desde el momento en que exportas</strong>. Cualquier cambio en el modelo requiere repetir todo el proceso desde cero.
          </p>
...
<div className="folder-tree mb-6">
            <span className="ft-folder">AG_Tools.extension/</span>      <span className="ft-comment">�?�??? tu extensión principal</span><br />
            &nbsp;&nbsp;<span className="ft-folder">Cubicación.tab/</span>      <span className="ft-comment">�?�??? pestaña en el ribbon de Revit</span><br />
            &nbsp;&nbsp;&nbsp;&nbsp;<span className="ft-folder">Reportes.panel/</span>  <span className="ft-comment">�?� panel de botones</span><br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="ft-folder">Cubicacion.pushbutton/</span> <span className="ft-comment">�?�??? el botón</span><br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="ft-file">script.py</span>   <span className="ft-comment">�?�??? tu código va aquí</span><br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="ft-file">icon.png</span>    <span className="ft-comment">�?�??? ícono 32x32 px (opcional)</span>
          </div>
<div className="steps-list">
            {/*  Step 2  */}
            <div className="step-item">
...
{/*  Script Completo  */}
        <div className="glass-card rounded-2xl p-8 md:p-10 border border-gray-200 dark:border-gray-700 mb-10 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-40 h-40 bg-blue-600/10 rounded-full blur-2xl"></div>
          <h3 className="text-2xl font-extrabold text-gray-900 dark:text-white mb-2 relative z-10">
            <i className="fa-brands fa-python text-green-400 mr-2"></i>
            Código Completo
          </h3>
          <p className="text-gray-600 dark:text-gray-400 mb-5 relative z-10 text-sm">Script listo para producción. Cópialo directamente en tu <span className="ic">script.py</span>:</p>
...
def es_hormigon(nombre_material):
    ...
    keywords = ["HORMIGON", "HORMIG��??N", "CONCRETE", "HA", "H20", "H25", "H30"]
    return any(k in nombre_material for k in keywords)
...
{/*  Resultado esperado  */}
        <div className="glass-card rounded-2xl p-8 md:p-10 border border-gray-200 dark:border-gray-700 mb-10">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-5">Si el modelo tiene materiales correctamente asignados, el reporte se ve así en la consola de pyRevit:</p>
...
<h4 className="font-bold text-gray-200 mb-2">Detección de material</h4>
          <p className="text-gray-600 dark:text-gray-400 text-sm">La función <span className="ic">obtener_nombre_material()</span> lee el parámetro <span className="ic">STRUCTURAL_MATERIAL_PARAM</span> de cada elemento, obtiene el ID del material asignado y consulta su nombre en el documento. Las funciones <span className="ic">es_acero()</span> y <span className="ic">es_hormigon()</span> buscan palabras clave en ese nombre �?�?� por eso es importante que tus materiales en Revit tengan nombres descriptivos.</p>
<h4 className="font-bold text-gray-200 mb-2 mt-6">Extracción del volumen</h4>
          <p className="text-gray-600 dark:text-gray-400 text-sm">Revit calcula el volumen real de cada elemento estructural y lo almacena en el parámetro <span className="ic">HOST_VOLUME_COMPUTED</span>. La API lo entrega en pies cúbicos �?�?� la conversión a m³ la hace <span className="ic">UnitUtils.ConvertFromInternalUnits()</span>. Este valor ya considera la geometría exacta del perfil, no una aproximación.</p>
...
{/*  Comparativa de Tiempo  */}
        <div className="glass-card rounded-2xl p-8 md:p-10 border border-gray-200 dark:border-gray-700 mb-10">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6 text-sm">Tiempo invertido por tarea en el flujo manual versus el flujo automatizado:</p>
...
<div className="space-y-5">
            <div>
              ...
              <p className="text-gray-500 text-sm mb-0">Verifica que el nombre de tu carpeta termine exactamente en <span className="ic">.extension</span>, <span className="ic">.tab</span>, <span className="ic">.panel</span> y <span className="ic">.pushbutton</span>. Un espacio de más o una mayúscula incorrecta hace que pyRevit no lo reconozca. Luego haz Reload.</p>
            </div>
            <div className="border-t border-gray-800 pt-5">
              <h4 className="font-bold text-gray-200 mb-1 text-sm">Elementos sin material asignado</h4>
              <p className="text-gray-500 text-sm mb-0">Si el reporte muestra elementos sin material, abre el modelo, selecciona esos elementos y asigna el material estructural correcto en las propiedades. El script avisa cuántos tienen ese problema.</p>
            </div>
            <div className="border-t border-gray-800 pt-5">
              <h4 className="font-bold text-gray-200 mb-1 text-sm">Error de conversión de unidades (Revit &lt; 2022)</h4>
              <p className="text-gray-500 text-sm mb-0">En versiones anteriores a 2022, <span className="ic">UnitTypeId</span> no existe. Reemplaza la conversión por <span className="ic">DisplayUnitType.DUT_CUBIC_METERS</span>, que es el equivalente en versiones más antiguas.</p>
            </div>
          </div>
        </div>
        ...
        <div className="glass-card rounded-2xl p-8 md:p-10 border border-gray-200 dark:border-gray-700 border-l-4 border-l-bim-blue">
          ...
          <ul className="space-y-3 mb-0">
            <li className="flex items-start text-gray-600 dark:text-gray-400">
              ...
              <span><strong className="text-gray-900 dark:text-white">El modelo es la fuente de verdad.</strong> Si el modelo cambia, el reporte también. Sin exportar nada, sin versiones desactualizadas.</span>
            </li>
            <li className="flex items-start text-gray-600 dark:text-gray-400">
              <span className="text-bim-blue mr-2 mt-1"><i className="fa-solid fa-check-circle"></i></span>
              <span><strong className="text-gray-900 dark:text-white">La detección por palabras clave es frágil si los materiales no tienen nombres descriptivos.</strong> Estandariza los nombres de materiales en tu plantilla de proyecto.</span>
            </li>
            <li className="flex items-start text-gray-600 dark:text-gray-400">
              <span className="text-bim-blue mr-2 mt-1"><i className="fa-solid fa-check-circle"></i></span>
              <span><strong className="text-gray-900 dark:text-white">pyRevit hace que la automatización sea accesible.</strong> Sin compilar DLLs ni configurar Visual Studio. Solo Python y la estructura de carpetas correcta.</span>
            </li>
            <li className="flex items-start text-gray-600 dark:text-gray-400">
              <span className="text-bim-blue mr-2 mt-1"><i className="fa-solid fa-check-circle"></i></span>
              <span><strong className="text-gray-900 dark:text-white">Cuando el proceso tarda 10 segundos, puedes iterar. Cuando tarda 2 horas, evitas hacerlo.</strong> Esa diferencia cambia cómo diseñas.</span>
            </li>
          </ul>
        </div>
</div>
