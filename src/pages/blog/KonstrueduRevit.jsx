...
{/* Contexto */}
 ...
 Con <strong className="text-white">15 años en obra</strong> modelando con Revit, Tekla y Navisworks en proyectos de minería, aeropuertos y hospitales, llego a un punto donde la certificación formal importa tanto como la experiencia práctica. No por ego — sino porque el mercado lo exige.
 </p>
 <p className="text-slate-400">
...
{/* Valoración personal */}
 ...
 <i className="fa-solid fa-star rating-star text-sm"></i>
 <i className="fa-solid fa-star rating-star text-sm"></i>
 <i className="fa-regular fa-star text-slate-600 text-sm"></i>
 </div>
...
{/* Grid completo de 14 cursos */}
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
{/* Curso 1 */}
 <div className="course-card flex gap-3 bg-slate-900/40 rounded-xl overflow-hidden border border-slate-800/60">
...
<div className="space-y-4 mt-2">
 ...
 <div>
 <strong className="text-white">Consolidación de metodología BIM formal:</strong>
 ...
 <span className="text-emerald-400 mt-1"><i className="fa-solid fa-check-circle"></i></span>
 <div>
 <strong className="text-white">Disciplinas que no son tu especialidad:</strong>
 ...
 <span className="text-emerald-400 mt-1"><i className="fa-solid fa-check-circle"></i></span>
 <div>
 <strong className="text-white">Certificación internacional reconocida:</strong>
...
<div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
 <div className="text-center bg-slate-900/40 rounded-xl p-4 border border-slate-800/60">
