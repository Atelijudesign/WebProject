...
(function () {
  ...
  /* ========================================
     CONTACT FORM â€â€ Formspree AJAX
     ======================================== */
  ...
  if (contactForm) {
    contactForm.addEventListener("submit", function (e) {
      ...
      fetch("https://formspree.io/f/mojkoayd", {
        ...
        .then(function (res) {
          if (res.ok) {
            msg.textContent = "âœâ€œ Mensaje enviado. Te respondo pronto.";
        ...
        .catch(function () {
          msg.textContent = "âœâ€â€ Error al enviar. EscrÃ­beme a andresgallo@pm.me";
